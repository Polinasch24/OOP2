...
best_student.lecturer_rate(cool_lecturer,'Python', 10)
student1.lecturer_rate(cool_lecturer1,'Python', 10)
student2.lecturer_rate(cool_lecturer1,'Python', 8)
best_student.lecturer_rate(cool_lecturer1,'Python', 9)
cool_reviewer1.rate_hw(best_student,'Python', 8)
cool_reviewer1.rate_hw(best_student,'Python', 9)
cool_reviewer1.rate_hw(best_student,'Python', 10)
...
list_student = [student1,student2,best_student]